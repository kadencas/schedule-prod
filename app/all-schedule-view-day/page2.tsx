...
interface PageProps {
 ...
 export default function Page2({ selectedDate = new Date() }: PageProps) {
  ...
  const [currentMonday, setCurrentMonday] = useState(getMostRecentMonday(selectedDate));
  ...
  // whenever parent’s date changes, update week + day
 useEffect(() => {
   setCurrentMonday(getMostRecentMonday(selectedDate));
